...
%Preface
\input{./additional/prefacio.tex}
\clearemptydoublepage

\prefacesection{Acknowledgements}
\input{./additional/chapter_acknowledgements}
\clearemptydoublepage

\prefacesection{Abstract}
\input{./additional/chapter_abstract}
\clearemptydoublepage

\prefacesection{Resumen}
\input{./additional/chapter_resumen}
\clearemptydoublepage
...
%------------------------------------------	
\input{./Capitulo1/ch_intro}
\clearemptydoublepage
%------------------------------------------	
\input{./Capitulo2/ch_basics}
\clearemptydoublepage
%------------------------------------------	
\input{./Capitulo3/ch_imitation}
\clearemptydoublepage
%------------------------------------------
\input{./Capitulo4/ch_multiple_behaviors}
\clearemptydoublepage
%------------------------------------------
\input{./Capitulo5/ch_fraccional}
\clearemptydoublepage
%------------------------------------------
\input{./Capitulo6/ch_postural_control}
\clearemptydoublepage
%------------------------------------------
\input{./Capitulo7/ch_conclusions}
\clearemptydoublepage
%------------------------------------------
\appendix
...
%REMOVE THIS!!!
I need to create a citation here \cite{gonzalez-fierro2014full} so the pdf builds.
