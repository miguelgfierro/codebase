 ...
 * Extended on 1/7/2020 for adding more English options
 */
    ...
    Chaffle.prototype = {
        ...
        randomStr: function () {
            ...
            switch (this.options.lang) {
                // UTF basic latin: https://www.w3schools.com/charsets/ref_utf_basic_latin.asp
                case 'en':
                ...
                case 'en-letters':
                    letters = [String.fromCharCode(65 + Math.round(Math.random() * 25)), String.fromCharCode(97 + Math.round(Math.random() * 25))]
